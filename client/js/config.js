...
document.addEventListener("DOMContentLoaded", function() {
    ...
    // Moved initialization to main.js to ensure DOM is ready
    // initializeSocketIO(); 
    
    // Initialize game components
    // Moved initialization to main.js
    // initializeUI();
    // setupParticlesBackground();
    // checkOrientation();
    
    // Listen for orientation changes
    // Moved listener setup to main.js
...
function checkOrientation() {
    ...
    if (!landscapePrompt) return; // Ensure element exists
...
function setupParticlesBackground() {
    ...
    if (!particlesElement) return; // Ensure element exists
